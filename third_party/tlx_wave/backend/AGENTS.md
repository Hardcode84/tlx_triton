...
- `ttg.convert_layout` lowers by composing source/result layout maps and must
  explicitly classify the result: alias, same-lane register remap, lane mux,
  cross-lane remap, cross-warp/CTA exchange, fragment pack/unpack/remap, or
  diagnostic.
