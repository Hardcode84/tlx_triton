...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32} {
  llvm.func @add_kernel(%arg0: !llvm.ptr<1> loc(#loc10), %arg1: !llvm.ptr<1> loc(#loc11), %arg2: !llvm.ptr<1> loc(#loc12), %arg3: i32 loc(#loc13), %arg4: !llvm.ptr<1>) {
    ...
    %x_buffer_ptr = "rocdl.make.buffer.rsrc"(%x_ptr, %constant_i16, %constant_i64, %constant_i32) : (!llvm.ptr<1>, i16, i64, i32) -> !llvm.ptr<8> loc(#loc18)
    %x_val = rocdl.raw.ptr.buffer.load %x_buffer_ptr, %mask_i1, %constant_i32, 0 : vector<4xf32> loc(#loc18)
    ...
    %y_buffer_ptr = "rocdl.make.buffer.rsrc"(%y_ptr, %constant_i16, %constant_i64, %constant_i32) : (!llvm.ptr<1>, i16, i64, i32) -> !llvm.ptr<8> loc(#loc19)
    %y_val = rocdl.raw.ptr.buffer.load %y_buffer_ptr, %mask_i1, %constant_i32, 0 : vector<4xf32> loc(#loc19)
