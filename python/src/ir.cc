...
void init_triton_ir(py::module_ &m) {
  ...
  py::class_<Attribute>(m, "attribute")
      ...
      .def(
          "get_shared_linear_layout",
          [](Attribute &self, MLIRContext &contextOwner) -> py::object {
            if (self.getContext() != &contextOwner)
  ...
  py::class_<Operation>(m, "operation")
      ...
      .def(
          "has_elementwise_trait",
          [](Operation &self) { return self.hasTrait<OpTrait::Elementwise>(); })
      .def("get_bool_attr",
           [](Operation &self, const std::string &name) -> py::object {
